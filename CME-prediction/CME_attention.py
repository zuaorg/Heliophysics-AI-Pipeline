...
class CMEAttention(Layer):
    def __init__(self,**kwargs):
        super(CMEAttention,self).__init__(**kwargs)
        CMEAttention.name='SEPCustomAttention'
    ...
    def build(self,input_shape): 
        ...
        super(CMEAttention, self).build(input_shape)
    ...
    def get_config(self):
        ...
        """
        return super(CMEAttention,self).get_config()