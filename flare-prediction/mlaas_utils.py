...
DEFAULT_INPUT_FILE = 'train_data/mlaas_train.csv'
logFileHandler = None
...
mapping ={1:"B", 2:"C", 3:"M", 4:'X'}
B = mapping[1]
C = mapping[2]
M = mapping[3]
X = mapping[4]

class_to_num = {"B":1, "C":2, "M":3, 'X':4}
...
def split_data(dataset, target_column = 'flarecn', test_percent=0.2):
...
def save_result_to_file(alg, result, dataset, flares_names):
    ...
    dataset_ens.insert(loc=0, column='Flare Prediction', value=result)
