...
train_data, test_data = train_test_split(filtered_sharp_data, test_size=0.2, shuffle=False)
...
cme_sharp_data = cme_sharp_data.sort_values(by=['HARPNUM', 'T_REC'], ascending=[True, True], ignore_index=True)
sep_sharp_data = sep_sharp_data.sort_values(by=['HARPNUM', 'T_REC'], ascending=[True, True], ignore_index=True)
